	...
	if item_results:
		for item_dict in item_results:
			...
			data = {
				...
				'delivered_v': (item_dict.delivered * item_dict.value),
				'sales_return': (item_dict.sales_return),
				'sales_return_v': (item_dict.sales_return * item_dict.value),
				'purchase': (item_dict.purchase),
				'purchase_v': (item_dict.purchase * item_dict.value),
				'purchase_return': (item_dict.purchase_return),
				'purchase_return_v': (item_dict.purchase_return * item_dict.value),
			...
			for warehouse in warehouses:
				...
				for tqty in balance:
					s1 += tqty.res
			data['opening'] = s
			data['opening_v'] = s * item_dict.value
			data['balance'] = s1
