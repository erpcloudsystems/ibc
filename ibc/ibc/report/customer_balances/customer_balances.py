...
def get_data(filters, show_party_name):
	...
	party_filters1 = {"sales_person": filters.get("sales_person")} if filters.get("sales_person") else {}
	party_filters2 = {"name": filters.get("party"), "sales_person": filters.get("sales_person")} if filters.get("party") and filters.get("sales_person") else {}

	if filters.get("party") and not filters.get("sales_person"):
	...
	if filters.get("sales_person") and not filters.get("party"):
		parties = frappe.get_all(
			filters.get("party_type"),
			fields=["name", party_name_field],
	...
	if filters.get("sales_person") and filters.get("party"):
		parties = frappe.get_all(
			filters.get("party_type"),
			fields=["name", party_name_field],
			filters=party_filters2,
			order_by="name",
		)
